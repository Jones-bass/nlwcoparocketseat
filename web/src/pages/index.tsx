...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      await navigator.clipboard.writeText(code); //copiando texto para a área de transferência automatico 
  ...
  return (
    <div className="max-w-[986px] h-screen mx-auto grid grid-cols-2 gap-40 items-center">
      <main>
